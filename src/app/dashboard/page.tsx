        ...
        {session.role === 'manager' || session.role === 'admin' ? (
          <div className="mt-8 bg-surface border border-amber-200 rounded-2xl overflow-hidden animate-fade-in-up">
            ...
            <div className="p-6 flex flex-wrap gap-3">
              ...
              <Link
                href="/claims"
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98]"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
